...
void collidedObject_callback(string nameCollidedObject)
{
    const char* text = "";
    //NUEVO
    if (nameCollidedObject == "pizza")
    {
        colisionpizza = true;
        text = "Pizza encontrada";
    ...
    if (nameCollidedObject == "billete")
    {
        colisionbillete = true;
        text = "Billete encontrado";
        showSecondMessage = true;
        Text->RenderText(text, -0.55f, 0.7f, 0.002f, glm::vec3(0.0f, 0.0f, 0.0f)); //despues de glm::vec3 es el color:)
        secondMessage->Draw(glm::vec2(0.0f, -0.75f), 1.0f);
    }
    else
        colisionbillete = false;

    if (nameCollidedObject == "coca")
    {
        colisionsoda = true;
        text = "Soda encontrada";
        showSecondMessage = true;
        Text->RenderText(text, -0.55f, 0.7f, 0.002f, glm::vec3(0.0f, 0.0f, 0.0f)); //despues de glm::vec3 es el color:)
        secondMessage->Draw(glm::vec2(0.0f, -0.75f), 1.0f);
    }
