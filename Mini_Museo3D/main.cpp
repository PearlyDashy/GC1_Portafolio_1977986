...
void initScene(Shader ourShader)
{
    ...
    models.push_back(Model("museo", "models/mainhall.obj", glm::vec3(1.9, 0.0, -4.55), glm::vec3(0, 00, 0), 0.0f, 0.060));
    models.push_back(Model("pintura1", "models/gm_painting.obj", glm::vec3(1.96, 2.77, -8.08), glm::vec3(0, 0, 0), 0.0f, 0.030));
    models.push_back(Model("pintura2", "models/rotating_picture.obj", glm::vec3(0.34, 2.74, -8.18), glm::vec3(0, 0, 0), 0.0f, 0.020));
    models.push_back(Model("escultura", "models/Sculpture_Tree_C.obj", glm::vec3(3.53, 1.26, -7.10), glm::vec3(0, 90, 0), 0.0f, 0.0030));
